...
<div class="down">
    <div class="hope" style="height: 150px;width: 1095px">
        ...
        <a href="javascript:showDialog()" class="sty" style="margin-top:80px;
            margin-left: 650px;width:80px;height: 30px;
            float:left;text-decoration:none; font-size: 20px;color: #040306" id="color">我要许愿

            <a href="infomation.php" class="sty" style="margin-top:80px;
            margin-left: 30px;width:80px;height: 30px;
            float:left;text-decoration:none; font-size: 20px;color: #040306" id="color">修改信息</a>
            <a href="admin_wish.php" class="sty" style="margin-top:80px;
            margin-left: 30px;width:80px;height: 30px;
            float:left;text-decoration:none; font-size: 20px;color: #040306" id="color">管理愿望</a>
            <a href="viewload.php" class="sty" style="margin-top:80px;
            margin-left: 30px;width:80px;height: 30px;
            float:left;text-decoration:none; font-size: 20px;color: #040306" id="color">愿望回顾</a>
        </a>
    </div>
